...
public class Emas extends CordovaPlugin {
    ...
    protected void pluginInitialize() {
        ...
        AppKey = preferences.getString("EmasAppKey", "");
        AppSecret = preferences.getString("EmasAppSecret", "");
        PackAgeName = preferences.getString("EmasPackageName", "");
    ...
    private void initFeedbackService() {
        ...
        FeedbackAPI.init(this, AppKey, AppSecret);
        /**
